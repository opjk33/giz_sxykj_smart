...
import com.gizwits.opensource.devicecontrol.ui.activity.GosEditDeviceAliasActivity;
import com.gizwits.opensource.devicecontrol.ui.activity.GosEditDeviceDelayActivity;
import com.gizwits.opensource.devicecontrol.ui.activity.GosScheduleListActivity;
import com.xxx.giz_sxykj_smart.R;

public class ComDeviceMoreActivity extends ComDeviceControlModuleBaseActivity implements OnClickListener {
...
//		startActivity(new Intent(this, GosScheduleListActivity.class));
	...
	private void startEditAliasActivity() {
		...
		startActivity(new Intent(this, ComEditDeviceAliasActivity.class));
	}
